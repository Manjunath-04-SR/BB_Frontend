      ...
      {open && (
        <div style={{ borderTop: "1px solid #f1f5f9" }}>
          ...
          {group.problems.map((problem, idx) => (
            <div key={problem._id} className={`grid grid-cols-[40px_1fr_100px_80px_80px_80px_100px] gap-2 items-center px-5 py-3 hover:bg-blue-50/40 transition-colors ${idx % 2 === 0 ? "bg-white" : "bg-slate-50/30"}`} style={{ borderTop: "1px solid #f8fafc" }}>
              ...
              <Link to={`/problems/${problem.slug}`} className="font-medium text-blue-600 hover:text-blue-800 hover:underline text-sm transition-colors truncate">
                {problem.title}
              </Link>

              <div>
                <span className={`inline-flex items-center px-2 py-0.5 rounded-md text-xs font-semibold ${DIFFICULTY_STYLES[problem.difficulty]}`} style={{ border: "1px solid" }}>
                  {problem.difficulty}
                </span>
              </div>
              ...
              <div className="flex justify-center">
                {problem.leetcodeUrl ? (
                  <a href={problem.leetcodeUrl} target="_blank" rel="noopener noreferrer" className="w-7 h-7 rounded-lg bg-orange-50 flex items-center justify-center hover:bg-orange-100 transition-colors" style={{ border: "1px solid #fed7aa" }} title="Open on LeetCode">
              ...
              <div className="flex justify-center">
                <button className="w-7 h-7 rounded-lg bg-slate-100 flex items-center justify-center hover:bg-green-50 hover:border-green-200 transition-colors" style={{ border: "1px solid #e2e8f0" }} title="View solution">
