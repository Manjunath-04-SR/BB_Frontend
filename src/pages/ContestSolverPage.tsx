...
import { ArrowLeft, Play, CheckCircle2, XCircle, Clock, Loader2, RotateCcw, Copy, Check, Terminal, BookOpen, Trophy, ChevronRight, Code2, AlertCircle, Send } from "lucide-react";
      ...
      <div className="flex-1 flex overflow-hidden" style={{ height: "calc(100vh - 49px)" }}>
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-slate-100">
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            ...
            <div className="border-t border-slate-300 bg-slate-100 shrink-0" style={{ height: "240px" }}>
              <div className="flex items-center border-b border-slate-700 px-4">
                {[
                  ...
                  <button key={key} onClick={() => setOutputTab(key)} className={`flex items-center gap-1.5 px-4 py-2.5 text-xs font-semibold border-b-2 transition-colors ${outputTab === key ? "border-blue-500 text-blue-400" : "border-transparent text-slate-400 hover:text-slate-200"}`}>
                    {icon}
                    {label}
